...
def read_data(start_time, end_time, **kwargs):
   ...
   # print "read_data"
    ...
    #print db,"hcvkdfhjv"
    if db:
	#print device_status_services_status,"device_status_services_status0000"
        cur = db.device_status_services_status.find({
            "check_timestamp": {"$gt": start_time, "$lt": end_time}
        })
	#print cur,"cur------"
        configs = config_module.parse_config_obj()
	#print configs,"hfjdhjh"
...
def insert_data(table, data_values,start_time, **kwargs):
	...
	db = utility_module.mysql_conn(configs=kwargs.get('configs'))
		...
		if result:
			...
			#print insert_dict,"update_dict++++"
		else:
			insert_dict['0'].append(data_values[i])
			#print insert_dict,"insert_dict___________"
	
	print insert_dict['1'],"update_dict++++"
	print insert_dict['0'],"insert_dict___________"
