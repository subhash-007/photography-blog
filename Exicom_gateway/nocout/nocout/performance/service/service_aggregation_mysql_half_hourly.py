...
mysql_configs = {
		...
		'port': int(desired_config.get('mysql_port')),
...
def mysql_main():
	...
	table = 'performance_performanceservicebihourly'
	docs = []
	...
	if docs:
	        mysql_db = mysql_conn()
	        mysql_export(table, columns, mysql_db, docs)


def mysql_export(table, columns, db, data_values):
